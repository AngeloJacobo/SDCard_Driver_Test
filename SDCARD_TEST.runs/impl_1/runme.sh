...
HD_PWD='/home/angelo/Desktop/SDCARD_TEST/SDCARD_TEST.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sdcard_interface.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sdcard_interface.tcl -notrace
