...
HD_PWD='/home/angelo/Desktop/SDCARD_TEST/SDCARD_TEST.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sdcard_interface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sdcard_interface.tcl
